# Wonseok add LMTFastokenizerWrapperCustom which is copied from OpenPrompt-v1.0.0 LMTokenizerWrapper class.
#   - The only difference is to inherit FastTokenizerWrapper instead of TokenizerWrapper
...
from .utils import FastTokenizerWrapper


class LMTFastokenizerWrapperCustom(FastTokenizerWrapper):
    r"""
    ...
    def tokenize_one_example(self, wrapped_example, teacher_forcing):
        ...
        for piece_id, piece in enumerate(wrapped_example):
            ...
            if (
                piece["text"] == self.tokenizer.eos_token
        ...
        )  # this will do nothing in GPT2 tokenizer
